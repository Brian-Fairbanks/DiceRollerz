    ...
    <div class="col s12 m7 xl10">
      <div class="card blue-grey darken-1">
        <div class="card-content white-text">
          ...
          <input placeholder="Password" name="password" onChange={handleInputChange} type="password" className="white-text"></input>
          <input placeholder="Confirm Password" onChange={handleInputChange} name="password2" type="password" className="white-text"></input>
